            ...
            {props.tools.map((tool) => {
              return (
                <div className={styles.tool_container} key={tool.name}>
                  ...
                  <img className={styles.move_img} src='move.png'/>
                </div>
              );
            })}
            <div className={styles.tool_container}>
              <img className={styles.locked_tool_img} src='locked_tool.png'/>
              <div className={styles.tool_contents}>
                <h3 className={styles.locked_text}>오픈 예정</h3>
              </div>
              <img className={styles.lockced_move_img} src='locked_move.png'/>
            </div>
          </div>
        </div>
      </div>
